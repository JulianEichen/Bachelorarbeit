function [A_ret,B_ret] = multiLvl_KL1_GGPT(Graph,maxnodes,ggpTries)
%    Multilevel KL scheme witih:
%           - Initial partition: with graph growing partitoining and 10
%           passes of KL1 
%           - single KL pass as refinement      
...
if numcoar>1
    ...
    for l=1:10
        [A_try,B_try]=  KL1(Graph,A_min,B_min,50); % Kernighan Lin
    ...
    for j=(numcoar-1):-1:1
        ...
        [A{j},B{j}] = KL1(Graphs{j},A_ur{j},B_ur{j},50);  % Kernighan Lin
