...
Dieses Repo dient der Kurzvorstellung meiner BA, im Sinne des Kolloquiums. Da der Code nicht bewertet wurde, wird dieser hier auch (zunächst) nicht vorgestellt, ist jedoch Teil des Repos. Die README.md entspricht zum Großteil der [Präsentation](koll.pdf), die Grafiken wurden jedoch leicht überarbeitet.
